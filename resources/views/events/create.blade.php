    ...
    <div class="py-12 bg-light container ">
        <div class="p-6 m-6 bg-white border-b border-gray-200 container shadow">
            ...
            <div class="row py-3 m-3 d-flex justify-content-center ">
                <p><span class="w-100 fw-bold"> Location:</span> <input type="text" name="location" class="border-1 p-2 rounded " value="{{ old('location') }}"> </p>
                <p><span class="w-100 fw-bold"> Date:</span>   <input type="date" name="date" value="{{ old('date') }}" class="border-1 p-2 rounded "> </p>
                ...
                <button type="submit" class="btn btn-outline-success btn-lg m-2"> Add event </button>
            </div>
        </div>
    </div>
